    ...
    return (
        <nav className='h-16 w-full bg-orange-500 dark:bg-orange-800 flex items-center justify-between px-5 py-5 xl:px-10'>
            ...
            <button
                ...
                className='h-10 w-fit px-4 xl:px-6 bg-orange-800 hover:bg-orange-700 dark:bg-orange-500 dark:text-white text-black font-semibold rounded transition-all duration-300 cursor-pointer'>
                {dark ? "Light" : "Dark"}
            </button>
        </nav>
    )
